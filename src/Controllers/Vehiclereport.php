    ...
    public function generate($user, $project, $client, $expenses, $tasks, $save = false) {
        ...
        foreach ($expenses as $key => $expense) {
            ...
            $items[] = '<tr>
                ...
                <td style="width:6%;">'.$expense->quantity.'</td>
                <td style="width:15%;">'.money($expense->amount, $user->parent->currency).'</td>
                <td style="width:16%;color:'.$statuscolor.';">'.$expense->status.'</td>
                <td style="width:8%;text-align:right;color:'.$paycolor.';">'.$expense->paid.'</td>
            </tr>';
        }
        ...
        <table cellpadding="5" cellspacing="5" style="width:100%;background-color: #404448;color:#ffffff;">
            <tr>
                ...
                <td style="width:16%;"><b>Status</b></td>
                <td style="width:8%;text-align:right;"><b>Paid</b></td>
            </tr>
        </table>
