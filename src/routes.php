...
Router::group(array(
    ...
    Router::group(array(
        ...
        Router::post('/projects/mark/complete', 'Projects@complete');
        Router::get('/projects/complete', 'Projects@completed');
        ...
        // Stores
        Router::get('/stores', 'Stores@get');
        Router::post('/stores/create', 'Stores@create');
        Router::post('/stores/update', 'Stores@update');
        Router::post('/stores/update/view', 'Stores@updateview');
        Router::post('/stores/delete', 'Stores@delete');
        ...
        Router::get('/tasks/daily', 'Tasks@daily');
